...
export default function Personal() {
  ...
  return (
    <div className="container" style={{
      ...
      borderRadius: '10px',
      marginTop: '2em',
      maxWidth: '200%', // Ensure the container doesn't exceed the screen width
      overflowX: 'hidden', // Prevent horizontal scrolling
      overflowY: 'hidden' // Allow vertical scrolling only if necessary
    }}>
      <div className="row">
        <div className="col-md-4 col-12" style={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}> {/* Ensure the image takes full width on small screens */}
          <img src={logo} className="img-fluid" alt="Portrait von David" style={{ marginTop: '20px', borderRadius: '10px' }} />
        </div>
        <div className="col-md-8 col-12"> {/* Ensure the text takes full width on small screens */}
          <h2>About Me</h2>
